...
# Key for SHC API calls
script_dir = os.path.dirname(os.path.abspath(__file__))
lab_key = "insert_your_lab_key_or_load_it_from_env"

# Path to the credentials file for VertexAI via Google Cloud
credentials_path = os.path.join(script_dir, "../mykeys/grolleau_application_default_credentials.json")

if __name__ == "main":
    ### Example usage of the API_text_to_text class with different models
    
    my_question = """First, state what LLM you are based on. Please read from the spec or consitution and answer with the precise version of the model.
